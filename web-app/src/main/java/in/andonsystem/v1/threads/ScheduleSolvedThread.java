...
public class ScheduleSolvedThread extends Thread {
    ...
    public void run() {
        System.out.println(
                "\nTime: " + new Date(System.currentTimeMillis()) + ",ScheduleSolvedThread.run() for issuedId :" +
        ...
        try {
            ...
            if (!result) {
                ...
                if (level == 2 &&
                    seekValue == 0) {       //Send SMS to user Level 2 only if Level 1 hasn't already sought help
