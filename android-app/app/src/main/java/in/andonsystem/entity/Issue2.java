...
@Entity
public class Issue2 implements Comparable<Issue2>{
    ...
    @Generated(hash = 75645482)
    private transient Issue2Dao myDao;
    ...
    public Issue2(Long id, Long buyerId, String problem, String description, Date raisedAt, Date ackAt, Date fixAt, Integer processingAt) {
        this.id = id;
     ...
     */
    @Override
    public int compareTo(Issue2 other) {
        int flag1 = 0;
    ...
    public User getRaisedByUser() {
        ...
        if (raisedByUser__resolvedKey == null || !raisedByUser__resolvedKey.equals(__key)) {
            final DaoSession daoSession = this.daoSession;
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
    ...
    public User getAckByUser() {
        ...
        if (ackByUser__resolvedKey == null || !ackByUser__resolvedKey.equals(__key)) {
            final DaoSession daoSession = this.daoSession;
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
    ...
    public User getFixByUser() {
        ...
        if (fixByUser__resolvedKey == null || !fixByUser__resolvedKey.equals(__key)) {
            final DaoSession daoSession = this.daoSession;
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 1931630612)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getIssue2Dao() : null;
    }
